...
/// <summary>
/// Represents an interceptor for auditing changes to entities that implement the <see cref="IAuditEntity.CreatedAt"/> interface.
/// This interceptor automatically sets the <see cref="IAuditEntity"/> and <see cref="IAuditEntity"/>
