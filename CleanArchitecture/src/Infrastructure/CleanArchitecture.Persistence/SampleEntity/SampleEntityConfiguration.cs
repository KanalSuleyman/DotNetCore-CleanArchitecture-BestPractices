...
/// </summary>
public class SampleEntityConfiguration : IEntityTypeConfiguration<Domain.Entities.SampleEntity>
{
    /// <summary>
    /// Configures the entity properties, relationships, and constraints for the <see cref="SampleEntity"/> entity.
    /// </summary>
    /// <param name="builder">The builder used to configure the entity.</param>
    public void Configure(EntityTypeBuilder<Domain.Entities.SampleEntity> builder)
    {
