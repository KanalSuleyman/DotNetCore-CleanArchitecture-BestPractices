...
/// <summary>
/// Represents a generic service result that encapsulates the outcome of a service operation.
/// This class is used to standardize the response format for success and failure scenarios.
/// </summary>
